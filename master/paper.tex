...
これらの結果を通じて，静的および動的な生産環境におけるスケジューリング最適化に対する強化学習手法の有効性を示した。\\
...
In static environments, optimization was performed using a Genetic Algorithm (GA) and a Deep Q-Network (DQN) based on deep reinforcement learning, and the performance of both methods was evaluated and compared. 
...
Through these evaluations, the effectiveness of reinforcement learning approaches for scheduling optimization in both static and dynamic production environments was demonstrated.\\
...
\textit{IEEE COMMUNICATIONS SURVEYS & TUTORIALS}. vol. 25, No. 4, FOURTH QUARTER 2023, pp. 3038-3067(2023).

\bibitem{ref10} B. Yu, Z. Hui, Z. Xin, C. Zheng, J. Riku, Y. Kun, "Toward Autonomous Multi-UAV Wireless Network: A Survey of Reinforcement Learning-Based Approaches"
\textit{IEEE COMMUNICATIONS SURVEYS & TUTORIALS}. vol. 25, No. 4, FOURTH QUARTER 2023, pp. 3038-3067(2023).
