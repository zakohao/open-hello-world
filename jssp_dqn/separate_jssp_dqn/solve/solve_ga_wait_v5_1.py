...
if __name__ == "__main__":
    ...
    CSV_NAME = r"[6]r[17]c,20gene.csv"
    ...
    # 6) 画在同一画布：上 GA / 下 DQN / 右侧 legend + metrics，且 x 轴对齐
    plot_compare_canvas(
        ga_sched, dqn_sched,
        num_jobs=num_jobs,
        ...
        out_png="ga_vs_dqn_compare.png",
        suptitle=f"GA vs DQN (file={os.path.basename(PROBLEM_FILE)})"
    )
